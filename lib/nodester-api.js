...
function authorize(credentials, callback) {
	...
	options.path = "/apps";
  options.headers = {'Host': options.host, "Authorization" : "Basic " + adminmod.lib.base64(credentials)};
...
function request(method, path, data, credentials, callback) {
  ...
  //console.log("query string ====>>> ", queryString);
    ...
    path: formatted_path,
    method : method,
    headers: {'Host': HOST, "Authorization" : "Basic " + adminmod.lib.base64(credentials)}
  };
